      ...
      <div className="bg-gray-100 py-4">
        <div className="container flex gap-4 items-center text-gray-500">
          ...
          <p className="capitalize">
            {productData?.category && productData?.category[0]}
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-500 text-[14px]">
              ...
              similique inventore quam ab dolorem harum explicabo nisi magnam,
              eaque dolorum?
            </p>
            ...
            <div className="capitalize">
              Category: {productData?.category && productData?.category[0]}
            </div>
